...
{
    ensure(miroir::field_count<reflected_character>() == 2);
    ensure(miroir::field_count<reflected_character_array>() == 1);
    ensure(miroir::field_count<reflected_pos2d>() == 2);
}

void test_for_each_fields()
{
    int reflected_character_iteration_count = 0;
    miroir::for_each_field<reflected_character>(
        [&reflected_character_iteration_count]<typename FieldInfo>()
        {
    ...
    miroir::for_each_field<reflected_character_array>(
        [&reflected_character_array_iteration_count]<typename FieldInfo>()
        {
    ...
    miroir::for_each_field<reflected_pos2d>(
        [&reflected_pos2_iteration_count]<typename FieldInfo>()
        {
...
void test_get_field_info_reflected_character()
{
    ...
    ensure((miroir::get_field_info<reflected_character, "hp">::ptr == &reflected_character::hp));
    ...
    ensure((miroir::get_field_info<reflected_character, "mana">::ptr == &reflected_character::mana));
...
void test_get_field_info_reflected_character_array()
{
    ...
    ensure((miroir::get_field_info<reflected_character_array, "characters">::ptr == &reflected_character_array::characters));
...
void test_get_field_info_reflected_pos2d()
{
    ...
    ensure((miroir::get_field_info<reflected_pos2d, "x">::ptr == &reflected_pos2d::x));
    ...
    ensure((miroir::get_field_info<reflected_pos2d, "y">::ptr == &reflected_pos2d::y));
...
void test_get_method_info_reflected_pos2d()
{
    ...
    ensure((miroir::get_method_info<reflected_pos2d, "show">::ptr == &reflected_pos2d::show));
}
